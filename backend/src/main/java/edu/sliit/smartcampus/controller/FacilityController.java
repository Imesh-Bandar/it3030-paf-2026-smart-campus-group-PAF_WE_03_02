...
@Tag(name = "Resources", description = "Facilities catalogue and booking calendar APIs")
public class FacilityController {

    private final FacilityService facilityService;
    private final BookingService bookingService;

    public FacilityController(FacilityService facilityService, BookingService bookingService) {
    ...
    public ResponseEntity<ResourceDto> getResource(@Parameter(description = "Resource identifier") @PathVariable UUID id) {
